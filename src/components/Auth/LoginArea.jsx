  ...
  const handleLogin = (e) => {
    ...
    fetch(process.env.REACT_APP_SERVER_API + "user/login", {
      ...
      .then((res) => {
        if (res) {
          if (res.id && res.role === "vendor") {
            ...
            localStorage.setItem("tokenExpiration", JSON.stringify(res.tokenExpiration));
      ...
      .catch((err) => {
        ...
        setAlertMsg("An error occurred during login. Please try again.");
      })
